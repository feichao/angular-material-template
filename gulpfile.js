...
// Copy translation to dist
gulp.task('translation', function() {
  return gulp.src(['assets/translation/**'])
    .pipe(gulp.dest('dist/assets/translation'))
    .pipe($.size({
      title: 'translation'
    }));
});
...
gulp.task('default', ['clean'], function(cb) {
  runSequence('styles', 'concat', ['jshint', 'html', 'images', 'fonts', 'translation', 'webicon', 'copy'], cb);
});
